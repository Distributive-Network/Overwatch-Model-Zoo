...
def preprocess(image_bytes, inputNames, *args, **kwargs):
    ...
    global im_scale
    img, im_scale = resize_image(img, scales, True)
    ...
    global im_info
    im_info = img.shape[0:2]
    
    feeds = dict()
    feeds[str(inputNames[0])] = im_tensor
    
    print("Done preprocess: ", feeds.keys())
